<?php
session_start();
$resultData=$_SESSION['Post_data'];
?>



<div id="success" class= "alert alert-success" style="display:none;"> Form has been successfully submitted</div> 
<?php 
if(isset($_GET['message']))
{?>
  <div class= "alert alert-success" style="text-align:center; font-size: 20px;" ><strong> 
 <?php echo $_GET['message'];?></strong> </div>
<script>
$('#success').show();
</script>
...
?>
<form action="app.php" name="myform" id="app_form" method="POST" enctype="multipart/form-data" class="sigpad">
...
<div class="row">
 ...
 <img src="images/line.jpg" width="100%" height="8" /> </div> 
  ...
  <div class="row">
           ...
           <div class="col-sm-8"><input  type="text" name="surname" id="surname" maxlength="78" value="<?php echo $resultData['surname'];?>" /></div>
  </div>
    <div class="row">
           <div class="col-sm-4">Forename(s)</div>
           <div class="col-sm-8"><input  type="text" name="forename" id="forename" maxlength="78" value="<?php echo $resultData['forename'];?>"/></div>
  </div>
  <div class="row">
  ...
  <div class="row">
           ...
           <div class="col-sm-8"><input name="marital_status" type="text" maxlength="78" value="<?php echo $resultData['marital_status'];?>"/></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Date of birth</div>
           <div class="col-sm-8"><input name="dob" type="text" id="datepicker" /></div>
  </div>
  ...
  <div class="row">
           ...
           <div class="col-sm-8"><textarea name="r_address" cols="" rows=""></textarea></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Postcode</div>
           <div class="col-sm-8"><input name="postcode" type="text" value="<?php echo $resultData['postcode'];?>" maxlength="20" /></div>
  </div>
...
advise previous address</div>
           <div class="col-sm-8"><textarea name="p_address" cols="" rows=""></textarea></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Postcode</div>
           <div class="col-sm-8"><input name="p_code" type="text" maxlength="20" value="<?php echo $resultData['p_code'];?>" /></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Home telephone</div>
           <div class="col-sm-8"><input name="home_tel" type="text" maxlength="15" value="<?php echo $resultData['home_tel'];?>"/></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Mobile</div>
           <div class="col-sm-8"><input name="mobile" type="text" maxlength="13" value="<?php echo $resultData['mobile'];?>"/></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Email address </div>
           <div class="col-sm-8"><input name="email" type="text" maxlength="30" value="<?php echo $resultData['email'];?>"/></div>
  </div>
  
  <div class="row">
           <div class="col-sm-10">Please tick this box if you do not wish to receive correspondence/pension statements by email: </div>
           <div class="col-sm-2 right-check"><input name="occ" type="checkbox" value="601" /></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Occupation</div>
           <div class="col-sm-8"><input name="occupation" type="text" maxlength="78" value="<?php echo $resultData['occupation'];?>"/></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Nationality </div>
           <div class="col-sm-8"><input name="nationality" type="text" maxlength="30" value="<?php echo $resultData['nationality'];?>"/></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">Passport number</div>
           <div class="col-sm-8"><input name="passport_number" type="text" maxlength="20" value="<?php echo $resultData['passport_number'];?>"/></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">UK tax reference number (if applicable)</div>
           <div class="col-sm-8"><input name="uk_text_ref_no" type="text" maxlength="20" value="<?php echo $resultData['uk_text_ref_no'];?>"/></div>
  </div>
  
  <div class="row">
           <div class="col-sm-4">UK national insurance number</div>
           <div class="col-sm-8"><input name="uk_nal_ins_no" type="text" maxlength="20" value="<?php echo $resultData['uk_nal_ins_no'];?>" /></div>
  </div>
  
   <div class="row">
           <div class="col-sm-8">Date left/leaving the UK</div>
           <div class="col-sm-4"><input name="date_uk" type="text" id="datepicker1" /></div>
  </div>
...
<div class="row">
<div class="col-sm-12"><textarea name="source_width" cols="" rows="12"></textarea></div>
</div>
<div class="row">
...
<div class="col-md-4  col-sm-3 col-xs-12 text">
                          <div class="radio_wrapper">
                              <input name="politically_expo" id="14" value="Yes" type="radio">
                              <label for="y2a1">Yes</label>
                              <input name="politically_expo" id="15" value="No" type="radio">
...
<div class="row">
<div class="col-sm-12"><textarea name="p_description" cols="" rows="4"></textarea></div>
</div>
<div class="row">
<div class="col-sm-12">
...
<div class="heads"><strong>Country/countries of tax residency</strong></div>
 <div><input name="countries_of_tax_residency" type="text" maxlength="30" /></div>
 <div><input name="countries_of_tax_residency1" type="text" maxlength="30"/></div>
  <div><input name="countries_of_tax_residency2" type="text" maxlength="30"/></div>
   <div><input name="countries_of_tax_residency3" type="text" maxlength="30"/></div>
</div>
...
<div><input name="tax_identification_number" type="text" maxlength="30"/></div>
 <div><input name="tax_identification_number1" type="text" maxlength="30"/></div>
  <div><input name="tax_identification_number2" type="text" maxlength="30"/></div>
   <div><input name="tax_identification_number3" type="text" maxlength="30"/></div>
</div> 
 </div>  
...
<div class="row">
           ...
           <div class="col-sm-2 right-check"><input name="pls_check" value="301" type="checkbox"></div>
  </div>
  <div class="row">
<div class="col-sm-12">
...
<div class="row">
           ...
           <div class="col-sm-8"><input name="print_name" type="text" maxlength="30" value="<?php echo $resultData['print_name'];?>"></div>
  </div>
  <div class="row">
           <div class="col-sm-4">Signature</div>
           <div class="col-sm-8">
            <div class="signature" style="margin-top: 10px;">
             <input type="hidden" name="p_signature" id="ims" value="" >
             <a href="#" id="hr" onclick="clear_canvas('signature1_canvas_canvas' , event , 'ims');">Clear</a>
  ...
  <div class="row">
           ...
           <div class="col-sm-4"><input type="text" name="p_date" id="datepicker3" class="datepicker" value="" maxlength="82"  /></div>
  </div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-sm-12"><input name="investment_platform" type="checkbox" value="302" /> <label><strong>Option A –</strong> Investment via internet based investment platform</label></div>
</div>
<div class="row">
<div class="col-sm-5"><p>Please advise selected platform</p></div>
<div class="col-sm-7"><input name="advise_selected" type="text" maxlength="30" value="<?php echo $resultData['advise_selected'];?>"/></div>
</div>
<div class="row">
...
<div class="row">
<div class="col-sm-12"><input name="investe_strategy" type="checkbox" value="303" /> <label><strong>Option B –</strong> Invested strategy – preferred investments/discretionary management investment</label></div>
</div>
<div class="row">
<div class="col-sm-12">
<textarea name="management_investment" cols="" rows="7"></textarea>
</div>
</div>
<div class="row">
<div class="col-sm-12">
...
<div class="col-sm-4"> <div class="radio_wrapper">
                              <input name="transferred_benefits" id="14" value="201" type="radio">
                              <label for="y2a1">Yes</label>
                              <input name="transferred_benefits" id="15" value="202" type="radio">
                              <label for="y2a2">No</label>
</div></div>
</div>
<div class="row amount-feed">
<div class="col-sm-2">Amount</div>
<div class="col-sm-3">£ <input name="amount" type="text" maxlength="20"/></div>
<div class="col-sm-2"> or </div>
<div class="col-sm-3"><input name="amount_per" type="text" placeholder="%" maxlength="20" /></div>
</div>
<div class="row">
<div class="col-sm-12">
<h3>Advisory fees</h3>
...
<div class="col-sm-4"> <div class="radio_wrapper">
                              <input name="pension_fund" id="14" value="101" type="radio">
                              <label for="y2a1">Yes</label>
                              <input name="pension_fund" id="15" value="102" type="radio">
                              <label for="y2a2">No</label>
</div></div>
</div>
<div class="row amount-feed">
<div class="col-sm-2">Amount</div>
<div class="col-sm-3">£ <input name="amounts" maxlength="15" type="text" value="<?php echo $resultData['amounts'];?>"/></div>
<div class="col-sm-2"> or </div>
<div class="col-sm-3"><input name="amounts_per" type="text" maxlength="20" placeholder="%" maxlength="10"/ value="<?php echo $resultData['amounts_per'];?>"></div>
</div>
<div class="row">
<div class="col-sm-12">
...
<div class="row">
           ...
           <div class="col-sm-8">
             <div class="signature" style="margin-top: 10px;">
             <input type="hidden" name="arg_signature" id="arg_sig" value="" >
             <a href="#" id="hr" onclick="clear_canvas('sig_canvas' , event , 'arg_sig');">Clear</a>
        <script type="text/javascript">
                  new sform.Signature({ 
                    id: "sig",
                    form_name: "myform",
  ...
  <div class="row">
           ...
           <div class="col-sm-8"><input name="Member_full_name" type="text" maxlength="30" value="<?php echo $resultData['Member_full_name'];?>"></div>
  </div>
  <div class="row">
           <div class="col-sm-8">Date</div>
           <div class="col-sm-4"><input name="m_date" type="text" id="datepicker4"></div>
  </div>
...
<div class="row">
 ...
 <div class="row">
 <div class="col-sm-4">Surname</div>
  <div class="col-sm-8"><input name="sanme" type="text" maxlength="78" value="<?php echo $resultData['sanme'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-4">Forename(s)</div>
  <div class="col-sm-8"><input name="fname" type="text" maxlength="78" value="<?php echo $resultData['fname'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-4">Address</div>
  <div class="col-sm-8"><textarea name="nominee_address" cols="" rows=""></textarea></div>
</div>
<div class="row">
 <div class="col-sm-4">Postcode</div>
  <div class="col-sm-8"><input name="n_postcode" type="text" maxlength="20" value="<?php echo $resultData['n_postcode'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-4">Relationship</div>
  <div class="col-sm-8"><input name="n_relationship" type="text" maxlength="30" value="<?php echo $resultData['n_relationship'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-8">Proportion of benefits(s) to be paid to this beneficiary</div>
  <div class="col-sm-4"><input name="n_beneficiary" type="text" maxlength="78" value="<?php echo $resultData['n_beneficiary'];?>"/></div>
</div>
<div class="row">
<h3>Nominee number 2</h3>
 <div class="col-sm-4">Surname</div>
  <div class="col-sm-8"><input name="nominee2_surname" type="text" maxlength="78" value="<?php echo $resultData['nominee2_surname'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-4">Forename(s)</div>
  <div class="col-sm-8"><input name="nominee2_fname" type="text" maxlength="78" value="<?php echo $resultData['nominee2_fname'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-4">Address</div>
  <div class="col-sm-8"><textarea name="nominee2_address" cols="" rows=""></textarea></div>
</div>
<div class="row">
 <div class="col-sm-4">Postcode</div>
  <div class="col-sm-8"><input name="nominee2_postcode" type="text" maxlength="20" value="<?php echo $resultData['nominee2_postcode'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-4">Relationship</div>
  <div class="col-sm-8"><input name="nominee2_rel" type="text" maxlength="40" value="<?php echo $resultData['nominee2_rel'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-8">Proportion of benefits(s) to be paid to this beneficiary</div>
  <div class="col-sm-4"><input name="nominee2_beneficiary" type="text" maxlength="78" value="<?php echo $resultData['nominee2_beneficiary'];?>"/></div>
</div>  
<div class="row">
<h3>Nominee number 3</h3>
 <div class="col-sm-4">Surname</div>
  <div class="col-sm-8"><input name="nominee3_surname" type="text" maxlength="78" value="<?php echo $resultData['nominee3_surname'];?>" /></div>
</div>
<div class="row">
 <div class="col-sm-4">Forename(s)</div>
  <div class="col-sm-8"><input name="nominee3_fname" type="text" maxlength="78" value="<?php echo $resultData['nominee3_fname'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-4">Address</div>
  <div class="col-sm-8"><textarea name="nominee3_address" cols="" rows=""></textarea></div>
</div>
<div class="row">
 <div class="col-sm-4">Postcode</div>
  <div class="col-sm-8"><input name="nominee3_postcode" type="text" maxlength="20" value="<?php echo $resultData['nominee3_postcode'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-4">Relationship</div>
  <div class="col-sm-8"><input name="nominee3_rel" type="text" maxlength="78" value="<?php echo $resultData['nominee3_rel'];?>"/></div>
</div>
<div class="row">
 <div class="col-sm-8">Proportion of benefits(s) to be paid to this beneficiary</div>
  <div class="col-sm-4"><input name="nominee3_beneficiary" type="text" maxlength="30"/></div>
</div>
<div class="row">
 <div class="col-sm-4"><strong>Signed</strong></div>
  <div class="col-sm-8">
     <div class="signature" style="margin-top: 10px;">
     <input type="hidden" name="nominee3_sig" id="get_pro" value="" >
     <a href="#" id="hr" onclick="clear_canvas('signature3_canvas_canvas' , event , 'get_pro');">Clear</a>
         <script type="text/javascript">
                  new sform.Signature({
                    id: "signature3_canvas",
                    form_name: "myform",
                    field_name: "signature3_canvas",
                    caption: "Signature",
                    w: 420,
                    h: 90
                  });
...
<div class="row"> 
 <div class="col-sm-8">Date</div>
  <div class="col-sm-4"><input name="nominee3_date" type="text" id="datepicker5" /></div>
</div>
<div class="row">
...
<div class="col-sm-8">
   <div class="signature" style="margin-top: 10px;">
   <input type="hidden" name="member_fname" id="parties" value="" >
   <a href="#" id="hr" onclick="clear_canvas('signat_canvas_canvas_canvas' , event , 'parties');">Clear</a>
        <script type="text/javascript">
                  new sform.Signature({
                    id: "signat_canvas_canvas",
                    form_name: "myform",
                    field_name: "signat_canvas_canvas",
                    caption: "Signature",
                    w: 420,
                    h: 90
                  });
...
<div class="row">
<div class="col-sm-4">Member’s full name</div>
<div class="col-sm-8"><input name="member_fname" type="text" maxlength="78" value="<?php echo $resultData['member_fname'];?>"/></div>
</div>

<div class="row">
<div class="col-sm-8">Date</div>
<div class="col-sm-4"><input name="member_date" type="text" id="datepicker9" /></div>
</div>
...
<div class="col-sm-8">
<div class="signature" style="margin-top: 10px;">
 <input type="hidden" name="witness_sig" id="presence" value="" >
 <a href="#" id="hr" onclick="clear_canvas('signature5_canvas_canvas' , event , 'presence');">Clear</a>
        <script type="text/javascript">
                  new sform.Signature({
                    id: "signature5_canvas",
                    form_name: "myform",
                    field_name: "signature5_canvas",
                    caption: "Signature",
                    w: 420,
                    h: 90
                  });
...
<div class="col-sm-8"><input name="witness_name" type="text" maxlength="78" value="<?php echo $resultData['witness_name'];?>"/></div>
</div>

<div class="row">
<div class="col-sm-8">Date</div>
<div class="col-sm-4"><input name="witness_date" type="text" id="datepicker6" /></div>
</div>
 
<div class="row">
<div class="col-sm-4">Address</div>
<div class="col-sm-8"><input name="witness_address" type="text" maxlength="78" value="<?php echo $resultData['witness_address'];?>"/></div>
</div>

<div class="row">
<div class="col-sm-4">Postcode</div>
<div class="col-sm-8"><input name="witness_postcode" type="text" maxlength="20" value="<?php echo $resultData['witness_postcode'];?>"/></div>
</div>

<div class="row">
<div class="col-sm-4">Occupation of witness </div>
<div class="col-sm-8"><input name="witness_ocp" type="text" maxlength="78" value="<?php echo $resultData['witness_ocp'];?>"/></div>
</div>
...
<input type="hidden" name="vantage_sig" id="signess" value="" >
 <a href="#" id="hr" onclick="clear_canvas('signature7_canvas_canvas' , event , 'signess');">Clear</a>
        <script type="text/javascript">
                  new sform.Signature({
                    id: "signature7_canvas",
                    form_name: "myform",
                    field_name: "signature7_canvas",
                    caption: "Signature",
                    w: 540,
                    h: 90
                  });
...
<div class="col-sm-6"><div class="signature" style="margin-top: 10px;">
<input type="hidden" name="vantage2_sig" id="vent" value="" >
<a href="#" id="hr" onclick="clear_canvas('signature6_canvas_canvas' , event , 'vent');">Clear</a>
               <script type="text/javascript">
                  new sform.Signature({
                    id: "signature6_canvas",
                    form_name: "myform",
                    field_name: "signature6_canvas",
                    caption: "Signature",
                    w: 540,
                    h: 90
                  });
...
<div class="col-sm-8"><input name="scheme" type="text" placeholder="Vantage Pension Scheme" maxlength="78" value="<?php echo $resultData['scheme'];?>" /></div>
</div>
  <div class="row">
<div class="col-sm-4">Scheme reference number<br />
(official use only)</div>
<div class="col-sm-8"><input name="scheme_ref_no" type="text" placeholder="QROPS" maxlength="30" value="<?php echo $resultData['scheme_ref_no'];?>"/></div>
</div>
 <div class="row">
<div class="col-sm-12">
...
<div class="row">
<div class="col-sm-4">Name of scheme</div>
<div class="col-sm-8"><input name="scheme_name" type="text" maxlength="78" value="<?php echo $resultData['scheme_name'];?>"/></div>
</div>

<div class="row">
<div class="col-sm-4">Name of transferring scheme</div>
<div class="col-sm-8"><input name="scheme_trns" type="text" maxlength="78" value="<?php echo $resultData['scheme_trns'];?>"/></div>
</div>

<div class="row">
<div class="col-sm-4">Address of scheme</div>
<div class="col-sm-8"><input name="scheme_add" type="text" maxlength="78" value="<?php echo $resultData['scheme_add'];?>"/></div>
</div>

<div class="row">
<div class="col-sm-4">Postcode</div>
<div class="col-sm-8"><input name="scheme_postcode" type="text" maxlength="20" value="<?php echo $resultData['scheme_postcode'];?>" /></div>
</div>

<div class="row">
<div class="col-sm-4">Scheme reference number</div>
<div class="col-sm-8"><input name="schemes_ref_no" type="text" maxlength="20" value="<?php echo $resultData['schemes_ref_no'];?>" /></div>
</div>

<div class="row">
<div class="col-sm-4">Pension value (if known)</div>
<div class="col-sm-8"><input name="scheme_value" type="text" maxlength="40" value="<?php echo $resultData['scheme_value'];?>"/></div>
</div>
...
<div class="col-sm-8">
 <div class="signature" style="margin-top: 10px;">
 <input type="hidden" name="scheme_signature" id="scheme" value="" >
 <a href="#" id="hr" onclick="clear_canvas('signature8_canvas' , event , 'scheme');">Clear</a>
        <script type="text/javascript">
                  new sform.Signature({
                    id: "signature8",
                    form_name: "myform",
...
<div class="row">
<div class="col-sm-4">Member’s full name</div>
<div class="col-sm-8"><input name="scheme_m_name" type="text" maxlength="78" value="<?php echo $resultData['scheme_m_name'];?>"/></div>
</div>

<div class="row">
<div class="col-sm-8">Date</div>
<div class="col-sm-4"><input name="scheme_dates" type="text" id="datepicker7" /></div>
</div>
...
<div class="row">
<div class="col-sm-12"><input name="investment_selection" type="checkbox" value="1001"  /> <label>Investment selection details (including supporting information, where applicable, page 5)</label></div>
</div>
<div class="row">
<div class="col-sm-12"><input name="signed_arg" type="checkbox" value="1002" /> <label>Completed and signed fee agreement (if applicable, page 5)</label></div>
</div>
<div class="row">
<div class="col-sm-12"><input name="benefit_nominee" type="checkbox" value="1003" /> <label>Death benefit nominee details (if applicable, page 7)</label></div>
</div>
<div class="row">
<div class="col-sm-12"><input name="signed_pre_arg" type="checkbox" value="1004" /> <label>Signed participation agreement (page 10)</label></div>
</div>
<div class="row">
<div class="col-sm-12"><input name="trns_req_form" type="checkbox" value="1005" /> <label>Transfer request form (page 11) (one for each pension fund to be transferred)</label></div>
</div>
<div class="row">
<div class="col-sm-12"><input name="certfire_cl_pass" type="checkbox" value="1006" /> <label>Certified copy of client passport</label></div>
</div>
<div class="row">
<div class="col-sm-12"><input name="client_address" type="checkbox" value="1007" /> <label>Client address verification (e.g. bank statement or utility bill not older than 3 months from date of this application or <br />
...
<div class="col-sm-4"><div class="radio_wrapper">
                              <input name="identification_purposes" id="14" value="14" type="radio">
                              <label for="y2a1">Yes</label>
                              <input name="identification_purposes" id="15" value="15" type="radio">
                              <label for="y2a2">No</label>
                          </div></div>
</div>
<div class="row">
...
<div class="row">
           ...
           <div class="col-sm-8"><input name="financial_adv_name" type="text" maxlength="78"></div>
  </div>
  ...
  <div class="row">
         ...
         <!-- <canvas id="signature8_canvas" width="420" height="90" ></canvas> -->
         <input type="hidden" name="imageData" id="get_imgid" value="" >
         <a href="#" id="hr" onclick="clear_canvas('signature8_canvas_canvas' , event , 'get_imgid');">Clear</a>

         <script type="text/javascript">

                   new sform.Signature({
                    id: "signature8_canvas",
                    form_name: "myform",
                    field_name: "signature8_canvas",
                    caption: "Signature",
                    w: 420,
                    h: 90
                  });
 ...
 -->  </div>
  ...
  <div class="row">
           <div class="col-sm-8" style="padding-left:30px; margin-top:10px;">Date</div>
           <div class="col-sm-4" style="margin-top:10px;"><input name="financial_date" id="datepicker8" value="" type="text"></div>
  </div>
  <div class="row">

  </form>
                    <div class="col-sm-12 sbmit" style="padding-left:25px;">
...
function clear_canvas(id, e , input_id ){
...
function submit_form(event){
                  ...
                  // var testCanvas = document.getElementById('signature8_canvas_canvas');
                  ...
                  // var argsign = document.getElementById('sig_canvas');
                  // var argee = testCanvas.toDataURL("image/png");
                  // document.getElementById("arg_sig").value = argee; 

                  // var as = document.getElementById('signature3_canvas');
                  // var ass = testCanvas.toDataURL("image/png");
                  // document.getElementById("get_pro").value = ass;

                  // var ssig = document.getElementById('signature7_canvas');
                  // var iis = testCanvas.toDataURL("image/png");
                  // document.getElementById("signess").value = iis;   

                  // var vents = document.getElementById('signature6_canvas');
                  // var tene = testCanvas.toDataURL("image/png");
                  // document.getElementById("vent").value = tene;    

                  // var partiese = document.getElementById('signat4_canvas'); 
                  // var partssa = testCanvas.toDataURL("image/png");
                  // document.getElementById("parties").value = partssa;     

                  // var presenceq = document.getElementById('signature5_canvas');
                  // var pres = testCanvas.toDataURL("image/png");
                  // document.getElementById("presence").value = pres;   

                  // var pro = document.getElementById('signature8_canvas');
                  // var pros = testCanvas.toDataURL("image/png");
                  // document.getElementById("scheme").value = pros;
                  ...
                  //   if($('input[name="signature8_canvas"]').val() == ""){
                  //     alert("Please sign in signature");
                  //     return false;
                  //     }

                  //     if($('input[name="signature1_canvas"]').val() == ""){
                  //     alert("Please sign in signature");
                  //     return false;
                  //     }

                  //      if($('input[name="sig_canvas"]').val() == ""){
                  //     alert("Please sign in signature");
                  //     return false;
                  //     }

                  //       if($('input[name="signature3_canvas"]').val() == ""){
                  //     alert("Please sign in signature");
                  //     return false;
                  //     }

                  //     if($('input[name="signature7_canvas"]').val() == ""){
                  //     alert("Please sign in signature");
                  //     return false;
                  //     }

                  //     if($('input[name="signature6_canvas"]').val() == ""){
                  //     alert("Please sign in signature");
                  //     return false;
                  //     }

                  //     if($('input[name="signat_canvas_canvas"]').val() == ""){
                  //     alert("Please sign in signature");
                  //     return false;
                  //     }

                  //     if($('input[name="signature5_canvas"]').val() == ""){
                  //     alert("Please sign in signature");
                  //     return false;
                  //     }
