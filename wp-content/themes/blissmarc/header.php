...
$geoplugin->locate();
//echo "{$geoplugin->region} <br />\n";

if ( $geoplugin->region == "CA") {
?>
<div style="background-color:#f9f9f9; color:#000; font-size:16px; text-align:center; paddding:20px; margin:0 0 20px 0px;">
<img src="http://blissmarc.com/wp-content/uploads/2016/05/Red_Exclamation_Dot.png" style="height:30px; width:30px; padding-top:15px;"> <br>
<strong>Important CALIFORNIA Notice for Health Care Business Owners!</strong></br>
<p style="padding-bottom:15px; line-height:30px;">The State of California is delicensing companies and fining them up to $200,000! You can avoid this and save money today!</br>
<a href="http://blissmarc.com/california" style="color:#blue;">Click here to learn more >></a></p>
</div>
<?php
}
if ( $geoplugin->region == "AZ") {
?>
<div style="background-color:#f9f9f9; color:#000; font-size:16px; text-align:center; paddding:20px; margin:0 0 20px 0px;">
<img src="http://blissmarc.com/wp-content/uploads/2016/05/Red_Exclamation_Dot.png" style="height:30px; width:30px; padding-top:15px;"> <br>
<strong>Important Arizona Notice for Health Care Business Owners!</strong></br>
<p style="padding-bottom:15px; line-height:30px;">Health Care Business Owners: The State of Arizona is delicensing companies and fining them $10,000 for not carrying worker’s compensation! They are now closing down companies with Stop Orders. You can avoid this and save money today!</br>
<a href="http://blissmarc.com/arizona" style="color:#blue;">Click here to learn more >></a></p>
</div>
<?php
}
if ( $geoplugin->region == "FL") {
?>
<div style="background-color:#f9f9f9; color:#000; font-size:16px; text-align:center; paddding:20px; margin:0 0 20px 0px;">
<img src="http://blissmarc.com/wp-content/uploads/2016/05/Red_Exclamation_Dot.png" style="height:30px; width:30px; padding-top:15px;"> <br>
<strong>Important Florida Notice for Health Care Business Owners!</strong></br>
<p style="padding-bottom:15px; line-height:30px;">Health Care Business Owners: The State of Florida is delicensing companies and fining them 2x their annual premiums for not carrying worker’s compensation! They are now closing down companies with Stop-Work Orders. You can avoid this and save money today!</br>
<a href="http://blissmarc.com/florida" style="color:#blue;">Click here to learn more >></a></p>
</div>
<?php
}
if ( $geoplugin->region == "IL") {
?>
<div style="background-color:#f9f9f9; color:#000; font-size:16px; text-align:center; paddding:20px; margin:0 0 20px 0px;">
<img src="http://blissmarc.com/wp-content/uploads/2016/05/Red_Exclamation_Dot.png" style="height:30px; width:30px; padding-top:15px;"> <br>
<strong>Important Illinois Notice for Health Care Business Owners!</strong></br>
<p style="padding-bottom:15px; line-height:30px;">Health Care Business Owners: The State of Illinois is delicensing companies and fining them $500 for every day without Worker’s Comp (minimum $10,000)! The owner is being held Personally Liable, but you can avoid this and save money today!</br>
<a href="http://blissmarc.com/illinois" style="color:#blue;">Click here to learn more >></a></p>
</div>
<?php
}
if ( $geoplugin->region == "NV") {
?>
<div style="background-color:#f9f9f9; color:#000; font-size:16px; text-align:center; paddding:20px; margin:0 0 20px 0px;">
<img src="http://blissmarc.com/wp-content/uploads/2016/05/Red_Exclamation_Dot.png" style="height:30px; width:30px; padding-top:15px;"> <br>
<strong>Important Nevada Notice for Health Care Business Owners!</strong></br>
<p style="padding-bottom:15px; line-height:30px;">Health Care Business Owners: The State of Nevada is delicensing companies and fining them $15,000 for not carrying worker’s compensation! They are now closing down companies with Cease Operations Orders. You can avoid this and save money today!</br>
<a href="http://blissmarc.com/nevada" style="color:#blue;">Click here to learn more >></a></p>
</div>
<?php
}
if ( $geoplugin->region == "NJ") {
?>
<div style="background-color:#f9f9f9; color:#000; font-size:16px; text-align:center; paddding:20px; margin:0 0 20px 0px;">
<img src="http://blissmarc.com/wp-content/uploads/2016/05/Red_Exclamation_Dot.png" style="height:30px; width:30px; padding-top:15px;"> <br>
<strong>Important New Jersey Notice for Health Care Business Owners!</strong></br>
<p style="padding-bottom:15px; line-height:30px;">Health Care Business Owners: The State of New Jersey is delicensing companies, charging owners with 4th Degree Crimes, and fining them $10,000 every 10 days for not carrying worker’s compensation insurance! They are now closing down companies with Cease Operations Orders. You can avoid this and save money today!</br>
<a href="http://blissmarc.com/new-jersey" style="color:#blue;">Click here to learn more >></a></p>
</div>
<?php
}
if ( $geoplugin->region == "WA") {
?>
<div style="background-color:#f9f9f9; color:#000; font-size:16px; text-align:center; paddding:20px; margin:0 0 20px 0px;">
<img src="http://blissmarc.com/wp-content/uploads/2016/05/Red_Exclamation_Dot.png" style="height:30px; width:30px; padding-top:15px;"> <br>
<strong>Important Washington Notice for Health Care Business Owners!</strong></br>
<p style="padding-bottom:15px; line-height:30px;">Health Care Business Owners: The State of Washington is delicensing companies and fining them $1,000 per day for not carrying worker’s compensation! They are now closing down companies with Stop Work Orders. You can avoid this and save money today!</br>
<a href="http://blissmarc.com/washington" style="color:#blue;">Click here to learn more >></a></p>
</div>
<?php
}
?>
